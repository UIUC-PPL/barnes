...
#define REQUEST_MOMENTS_PRIORITY (0)
#define RECV_MOMENTS_PRIORITY (1)
#define REQUEST_NODE_PRIORITY (2)
#define RECV_NODE_PRIORITY (3)
#define REMOTE_GRAVITY_PRIORITY (4)
#define REQUEST_PARTICLES_PRIORITY (5)
#define RECV_PARTICLES_PRIORITY (6)
#define LOCAL_GRAVITY_PRIORITY (7)
